      ...
      <section id="research" className="py-16 md:py-24">
        <div className="container max-w-3xl">
          ...
          <p className="text-center text-muted-foreground mb-12 leading-relaxed">
            AAMHI programmatic activities are driven by culturally responsive research and program evaluation data or findings from peer-reviewed, scientific literature. Help us answer key questions for community impact. 
          </p>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="bg-background rounded-2xl p-8 md:p-12 shadow-sm border border-border text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Despite the pervasive model minority myth, the well-being and mental health needs of Asian and Asian American communities are too often rendered invisible. AAMHI is dedicated to changing this narrative through culturally responsive care, clinical training, and targeted research. Your partnership makes this work possible.
            </p>
