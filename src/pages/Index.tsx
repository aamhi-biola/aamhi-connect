      ...
      <section id="why" className="py-16 md:py-24 bg-section-alt">
        <div className="container max-w-3xl">
          ...
          <p className="text-center text-muted-foreground italic">
            Compared to any other racial-ethnic groups, Asian-Americans are the least likely to access mental health care (Alegria, 2008; Derr, 2016; SAMHSA, 2019). This is true even when they endorse mental health needs, have serious psychological distress and experience a major depressive episode (Yang et al., 2020). In fact, only one out of five Asian adults with a mental illness received mental health care. The American Psychiatric Association (APA, 2020) points to structural and cultural barriers that contribute to this mental health disparity. Structural barriers include cost, language barriers and lack of cultural competency from providers, and cultural barriers include stigma and shame associated with seeking mental health care (APA, 2020; Eng & TenElshof, 2020). In addition, Asians are more likely to endorse not knowing where to go for mental health treatment compared to Whites (Yang et al., 2020). These problems point to the need for culturally specific outreach and mental health services tailored to Asian/Asian American (AAA) communities.
          </p>
        </div>
      </section>
