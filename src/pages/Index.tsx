...
{/* Why AAMHI - Integrated background image here */}
      ...
      <div className="relative overflow-hidden">
        ...
        <div 
          className="absolute inset-0 w-full h-full opacity-20 pointer-events-none filter grayscale blur-sm"
          style={{ 
        ...
        <div className="relative" style={{ zIndex: 2 }}>
          ...
          {/* Service - Removed background class to let tree show */}
          ...
          {/* Support / Donate - Removed background class to let tree show */}
          <section id="support" className="py-16 md:py-24">
            <div className="container max-w-4xl">
              <SectionHeading title="Partner With Us" />
              
              {/* Added backdrop-blur-sm and opacity to background to create frosted glass effect */}
